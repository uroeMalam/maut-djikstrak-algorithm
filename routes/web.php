...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/subkriteria/data-table', [SubkriteriaController::class, 'DataTable'])->name('subkriteria_dataTable');
     ...
     Route::get('/jarak/tambah',[JarakController::class, 'create'])->name('jarak-create'); 
     Route::post('/jarak/simpan',[JarakController::class, 'store'])->name('jarak-simpan');
     Route::get('/jarak/edit/{id}',[JarakController::class, 'edit'])->name('jarak-edit');
     Route::post('/jarak/update',[JarakController::class, 'update'])->name('jarak-update');
     Route::delete('/jarak/delete',[JarakController::class, 'destroy'])->name('jarak-delete');
     Route::get('/jarak/data-table', [JarakController::class, 'DataTable'])->name('jarak_dataTable');
