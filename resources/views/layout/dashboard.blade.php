          ...
          <div class="card bg-gradient-primary border-0">
            ...
            <div class="card-body">
              ...
              <p class="mt-3 mb-0 text-sm">
                <a href="#!" class="text-nowrap text-white font-weight-600">Data Sub Kriteria</a>
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="col-xl-3 col-md-6">
          <div class="card bg-gradient-primary border-0">
            ...
            <div class="card-body">
              <div class="row">
                <div class="col">
                  <h5 class="card-title text-uppercase text-muted mb-0 text-white">Data Sub Kritria</h5>
                  <span class="h2 font-weight-bold mb-0 text-white">28</span>
                  <div class="progress progress-xs mt-3 mb-0">
            ...
            <div class="card-body">
              <div class="row">
                <div class="col">
                  ...
                  <span class="h2 font-weight-bold mb-0 text-white">25</span>
                  <div class="progress progress-xs mt-3 mb-0">
                    <div class="progress-bar bg-success" role="progressbar" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100" style="width: 80%;"></div>
                  </div>
                </div>
