          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link {{ Request::is('lahan') ? 'active':''}}" href="{{('lahan')}}">
                ...
                <span class="nav-link-text">Data Luas Lahan</span>
              </a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link {{ Request::is('penilaian') ? 'active':''}}" href="{{('penilaian')}}">
                ...
                <span class="nav-link-text">Penilaian MAUT</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link {{ Request::is('hasil') ? 'active':''}}" href="{{('hasil')}}">
                <i class="fas fa-fw fa-calculator text-info"></i>
                <span class="nav-link-text">Hasil Akhir MAUT</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link {{ Request::is('jarak') ? 'active':''}}" href="{{('jarak')}}">
                <i class="fas fa-fw fa-route text-info"></i>
                <span class="nav-link-text">Jarak DJIKSTRA</span>
              </a>
            </li>            
            <li class="nav-item">
