        ...
        <div class="col">
          <div class="card">
            ...
            <div class="card-header">
              <h2 class="mb-0">Jarak Djikstra</h2>
              <div class="col-auto">
              ...
              <table class="table table-flush text-center data-table">
                <thead class="thead-light">
                  <tr>
                    ...
                    <th style="font-size: 13px;">Titik A</th>
                    <th style="font-size: 13px;">Titik B</th>
                    <th style="font-size: 13px;">Jarak</th>
...
@push('page-scripts')
    ...
    $(document).ready(function () {
      ...
      var table = $('.data-table').DataTable({
        ...
        serverSide: true,
        rowId:"id",
        ajax: "{{ route('jarak_dataTable') }}",
        columns: [
            {data:'DT_RowIndex',name: 'DT_RowIndex',orderable:false,searchable:false},
            {data: 'kecamatan_a', name: 'kecamatan_a'},
            {data: 'kecamatan_b', name: 'kecamatan_b'},
